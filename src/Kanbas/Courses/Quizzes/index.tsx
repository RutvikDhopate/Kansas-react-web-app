                        ...
                        .map((quiz: any) => (
                            <li className="wd-quiz-list-item list-group-item p-3 ps-1 wd-lesson">
                                ...
                                <div style={{marginLeft:"75px"}}>
                                    <a className="wd-quiz-link text-black"
                                    ...
                                    <br/>
                                    <span><a className="wd-quiz-list-link text-danger"
                                        href="https://www.google.com" style={{textDecoration:"none"}}>Multiple Modules</a> | <strong>Not available until</strong> {formatDate(quiz.availabilityDate)} | </span>
                                    <br />
                                    <span>
